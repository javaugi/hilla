 ...
 */
function _fullFQNMethod(input: number | undefined): Promise<string | undefined> {
 ...
 * Return array of int
 */
function _getArrayInt(input: Array<string | undefined> | undefined): Promise<Array<number> | undefined> {
 ...
 */
function _getBooleanValue(input: Record<string, User | undefined> | undefined): Promise<boolean> {
 ...
 * Return boolean value
 */
function _getTwoParameters(input: string | undefined, secondInput: number): Promise<boolean> {
 ...
 */
function _getUserById(id: number): Promise<User | undefined> {
  return client.call('JsonTestEndpoint', 'getUserById', { id });
}

function _inputBeanTypeDependency(input: Version | undefined): Promise<void> {
  return client.call('JsonTestEndpoint', 'inputBeanTypeDependency', { input });
}

function _inputBeanTypeLocal(input: Status | undefined): Promise<void> {
...
function _reservedWordInParameter(_delete: boolean): Promise<void> {
 ...
 *
 */
function _updateUser(user: User | undefined): Promise<void> {
