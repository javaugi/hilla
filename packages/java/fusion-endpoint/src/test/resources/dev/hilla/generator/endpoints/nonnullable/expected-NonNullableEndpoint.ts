...
function _echoMap(shouldBeNotNull: boolean): Promise<Record<string, NonNullableModel | undefined>> {
...
function _echoNonNullableMap(nonNullableList: Array<string>): Promise<Record<string, NonNullableModel>> {
...
function _getNonNullableString(input: string | undefined): Promise<string> {
...
function _sendParameterType(parameterType: ParameterType | undefined): Promise<void> {
