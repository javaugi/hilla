...
function _delete(id: number | undefined): Promise<void> {
...
function _get(id: number | undefined): Promise<Person | undefined> {
  return client.call('PersonEndpoint', 'get', { id });
}

function _getPage(pageSize: number, pageNumber: number): Promise<Array<Person | undefined> | undefined> {
...
function _update(entity: Person | undefined): Promise<Person | undefined> {
