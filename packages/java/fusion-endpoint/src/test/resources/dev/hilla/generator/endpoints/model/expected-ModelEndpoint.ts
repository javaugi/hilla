...
function _getAccountByGroups(groups: Array<Group | undefined> | undefined): Promise<Account | undefined> {
 ...
 */
function _getAccountByUserName(userName: string | undefined): Promise<Account | undefined> {
