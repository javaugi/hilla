...
function _echoEnum(value: MyEnum | undefined): Promise<MyEnum | undefined> {
...
function _setEnum(value: MyEnum | undefined): Promise<void> {
  return client.call('EnumEndpoint', 'setEnum', { value });
}

export { _echoEnum as echoEnum, _echoListEnum as echoListEnum, _getEnum as getEnum, _setEnum as setEnum };
