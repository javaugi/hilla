...
function _echoDate(date: string | undefined): Promise<string | undefined> {
  return client.call('DateTimeEndpoint', 'echoDate', { date });
}

function _echoInstant(instant: string | undefined): Promise<string | undefined> {
...
function _echoLocalDate(localDate: string | undefined): Promise<string | undefined> {
  return client.call('DateTimeEndpoint', 'echoLocalDate', { localDate });
}

function _echoLocalDateTime(localDateTime: string | undefined): Promise<string | undefined> {
  return client.call('DateTimeEndpoint', 'echoLocalDateTime', { localDateTime });
}

function _echoLocalTime(localTime: string | undefined): Promise<string | undefined> {
