 ...
 * Return a collection
 */
function _getCollectionByAuthor(name: string | undefined): Promise<Collection | undefined> {
...
export { _getCollectionByAuthor as getCollectionByAuthor, _getListOfUserName as getListOfUserName };
