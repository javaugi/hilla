 ...
 * Return a collection
 */
function _getSameModelPackage(name: string | undefined): Promise<Account | undefined> {
  return client.call('ModelPackageEndpoint', 'getSameModelPackage', { name });
}

export { _getListOfUserName as getListOfUserName, _getSameModelPackage as getSameModelPackage };
